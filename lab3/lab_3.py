...
Original file is located at
    https://colab.research.google.com/drive/1TIqyzxLda5mbB3PtkAVMjW-rra5zoPcN
...
def evaluate_model(
    ...
    with torch.no_grad():
        ...
        if threshold:
          ...
          optimal_threshold = get_optimal_threshold(precisions, recalls, thresholds)[1]
    ...
    return {
        ...
        "recall": recall,
        "F1-score": f1,
        "threshold": optimal_threshold  #for later use
    }
...
for epoch_num in range(max_epochs):
    ...
    if best_val_loss > valid_metrics["loss"]:
      ...
      best_model = valid_metrics["model"]
    ...
    if steps_without_improvement >= early_stopping_patience:
        print(f"Early stopping for epoch {epoch_num}")
        break
